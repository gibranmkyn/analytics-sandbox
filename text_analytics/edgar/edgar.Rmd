...
stopw_custom <- c('vs', 'financial', 'statement', 'exhibit','report','figure','fig','tab','table', 'mda', 'company', 'footnote', 'item', 'part')
...
```{r}
dbGetQuery(conn, 'SELECT * FROM cleaned_10k_mda')
dbExecute(conn, 'DELETE FROM cleaned_10k_mda')
```
...
dbGetQuery(conn, 'SELECT * FROM master_index')


dbGetQuery(conn, 'SELECT * FROM cleaned_10q LEFT JOIN master_index ON cleaned_10q.accession_number = master_index.accession_number WHERE cik ="1359841"')

dbExecute(conn, 'DELETE FROM cleaned_10q WHERE accession_number = "0000018230-09-000175"')
...
NEXT STEPS.......
1) Tokenise and remove items item and such!!!!!!!!!!!!!!
1) check why "1013871" "72903"  not there
2) check how many have empty text and why
